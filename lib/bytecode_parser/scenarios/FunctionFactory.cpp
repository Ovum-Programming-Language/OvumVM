...
vm::execution_tree::Function FunctionFactory::MakeRegular(
...
vm::execution_tree::PureFunction<Base> FunctionFactory::WrapPure(
    Base&& base,
    std::vector<std::string> argument_types) {
  return vm::execution_tree::PureFunction<Base>(
...
std::unique_ptr<vm::execution_tree::IFunctionExecutable> FunctionFactory::Create(
  ...
  auto regular = MakeRegular(id, arity, std::move(body));
...
FunctionFactory::WrapPure<vm::execution_tree::Function>(
    vm::execution_tree::Function&& base,
    std::vector<std::string> argument_types);
...
template std::unique_ptr<vm::execution_tree::JitCompilingFunction<vm::execution_tree::PureFunction<vm::execution_tree::Function>>>
