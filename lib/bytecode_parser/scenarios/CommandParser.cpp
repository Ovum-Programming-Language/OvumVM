...
std::expected<void, BytecodeParserError> CommandParser::ParseSingleStatement(std::shared_ptr<ParserContext> ctx,
...
std::expected<void, BytecodeParserError> CommandParser::Handle(std::shared_ptr<ParserContext> ctx) {
